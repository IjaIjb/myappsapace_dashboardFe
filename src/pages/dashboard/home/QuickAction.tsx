...
<h4 className='text-[#382B67] text-[16px] font-[700] pb-2'>Quick Action</h4>
...
<img
              ...
              // height={140}
            />
<h5 className='text-[#9D9D9D] text-[12px] font-[400]'>Create a Product</h5>
</div>
...
<img
              ...
              // height={140}
            />
<h5 className='text-[#9D9D9D] text-[12px] font-[400]'>Create Customer</h5>
</div>
</div>
...
<img
              ...
              // height={140}
            />
<h5 className='text-[#9D9D9D] text-[12px] font-[400]'>Create an Order</h5>
</div>
</div>
    </div>
  )
