...
const CreateCustomer = () => {
    ...
    console.log(stores)
      ...
      const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
          ...
          const response: any = await UserApis.createCustomer(selectedStore, formData);
          ...
          toast.error(error?.response?.data?.message || "An error occurred while creating the customer.");
        } finally {
          setLoader(false);
        }
      };
  ...
  return (
    <DashboardLayout>
      <div>
        <h5 className="text-[#000000] text-[16px] font-[600] mb-7">Create Customer</h5>
        <form onSubmit={handleSubmit} className="flex flex-col max-w-[570px] mt-5 gap-3">
          ...
          {/* Customer Name */}
          <div>
            <label htmlFor="first_name" className="text-[#2B2C2B] text-[12px] font-[400]">
            First Name
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="last_name" className="text-[#2B2C2B] text-[12px] font-[400]">
            Last Name
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="email" className="text-[#2B2C2B] text-[12px] font-[400]">
           Email
            </label>
            <input
              type="email"
          ...
          <div>
            <label htmlFor="username" className="text-[#2B2C2B] text-[12px] font-[400]">
           Username
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="phone_number" className="text-[#2B2C2B] text-[12px] font-[400]">
          Phone Number
            </label>
            <input
              type="number"
