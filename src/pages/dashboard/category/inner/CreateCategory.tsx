...
console.log(stores)
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response: any = await UserApis.createCategory(selectedStore, formData);
  ...
  return (
    <DashboardLayout>
      <div>
        <h5 className="text-[#000000] text-[16px] font-[600] mb-7">Create Category</h5>
              ...
              <label className="flex w-full bg-[#FBFBFF] border border-[#D8D8E2] flex-col items-center justify-center rounded-[5px] cursor-pointer">
                <div className="flex flex-col items-center justify-center h-[80px]">
                  {categoryLogo ? (
                    ...
                    <div>
                      <p className="text-[#9D9D9D] text-[12px] font-[400]">Upload Logo Image here</p>
